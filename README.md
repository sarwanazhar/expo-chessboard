...
## **You can use this package to make a multiplayer game with sockets backend i have example** [here](https://github.com/sarwanazhar/expo-chessboard/blob/main/exampleMultiplayer.tsx)
